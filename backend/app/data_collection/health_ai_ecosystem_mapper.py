...
class HealthAIOrganization:
    ...
    country_name: str
    organization_type: (
        str  # 'university', 'startup', 'hospital', 'research_institute', 'government'
    )
...
class HealthAIEcosystemMapper:
    ...
    KNOWN_UNIVERSITIES = {
        "ZAF": [
            {
                ...
                "url": "uct.ac.za",
                "programs": ["medical_informatics", "biomedical_engineering"],
            },
            {
                "name": "University of the Witwatersrand",
                "url": "wits.ac.za",
                "programs": ["health_informatics", "medical_ai"],
            },
            {
                "name": "Stellenbosch University",
                "url": "sun.ac.za",
                "programs": ["biomedical_engineering", "health_tech"],
            },
            {
                "name": "University of KwaZulu-Natal",
                "url": "ukzn.ac.za",
                "programs": ["medical_informatics"],
            },
        ],
        "KEN": [
            {
                ...
                "url": "uonbi.ac.ke",
                "programs": ["health_informatics", "medical_engineering"],
            },
            {
                "name": "Kenyatta University",
                "url": "ku.ac.ke",
                "programs": ["health_technology"],
            },
            {
                "name": "Strathmore University",
                "url": "strathmore.edu",
                "programs": ["health_informatics", "data_science"],
            },
        ],
        "NGA": [
            {
                ...
                "url": "unilag.edu.ng",
                "programs": ["biomedical_engineering", "health_informatics"],
            },
            {
        ...
        "GHA": [
            ...
            },
            {
                ...
                "url": "knust.edu.gh",
                "programs": ["biomedical_engineering"],
            },
        ],
        "EGY": [
            {
                ...
                "url": "cu.edu.eg",
                "programs": ["biomedical_engineering", "medical_informatics"],
            },
            {
        ...
        "ZAF": [
            {
                "name": "Pic4Care",
                "type": "startup",
                "focus": ["medical_imaging", "ai_diagnostics"],
                "founded": 2019,
            },
            {
                "name": "Entelect Health",
                "type": "company",
                "focus": ["health_analytics", "ai_platform"],
                "founded": 2015,
            },
            {
                "name": "Cortex Logic",
                "type": "startup",
                "focus": ["clinical_ai", "decision_support"],
                "founded": 2018,
            },
        ],
        "KEN": [
            {
                "name": "Ilara Health",
                "type": "startup",
                "focus": ["diagnostic_ai", "point_of_care"],
                "founded": 2019,
            },
            {
                "name": "Zuri Health",
                "type": "startup",
                "focus": ["telemedicine", "ai_triage"],
                "founded": 2018,
            },
            {
                "name": "Lapaire",
                "type": "startup",
                "focus": ["eye_care_ai", "mobile_health"],
                "founded": 2020,
            },
        ],
        "NGA": [
            {
                "name": "Helium Health",
                "type": "startup",
                "focus": ["emr_systems", "health_analytics"],
                "founded": 2016,
            },
            {
                "name": "WellaHealth",
                "type": "startup",
                "focus": ["health_insurance_ai", "fraud_detection"],
                "founded": 2017,
            },
            {
                "name": "MDaaS Global",
                "type": "startup",
                "focus": ["diagnostic_ai", "medical_imaging"],
                "founded": 2017,
            },
        ],
        "GHA": [
            {
                "name": "mPharma",
                "type": "startup",
                "focus": ["pharmacy_ai", "supply_chain"],
                "founded": 2013,
            },
            {
                "name": "Redbird",
                "type": "startup",
                "focus": ["maternal_health_ai", "predictive_analytics"],
                "founded": 2019,
            },
        ],
        "EGY": [
            {
                "name": "Valeo Vara",
                "type": "startup",
                "focus": ["radiology_ai", "medical_imaging"],
                "founded": 2018,
            },
            {
                "name": "O7 Therapy",
                "type": "startup",
                "focus": ["mental_health_ai", "therapy_matching"],
                "founded": 2019,
            },
        ],
    }
    ...
    def map_university_programs(self, country_code: str) -> List[HealthAIOrganization]:
        ...
        for university in universities:
            try:
                ...
                if self._verify_university_program(
                    university["url"], university["programs"]
                ):
    ...
    def _verify_university_program(
        self, university_url: str, programs: List[str]
    ) -> bool:
    ...
    def map_health_ai_startups(self, country_code: str) -> List[HealthAIOrganization]:
        ...
        if country_code not in self.KNOWN_HEALTH_AI_COMPANIES:
            logger.warning(
                f"No known health AI companies configured for {country_code}"
            )
            return organizations
    ...
    def search_healthcare_ai_pilots(
        self, country_code: str
    ) -> List[HealthAIOrganization]:
        """
        ...
        known_pilots = {
            "ZAF": [
                {
                    "name": "National Health Laboratory Service AI Initiative",
                    "type": "government",
                    "focus": ["laboratory_ai", "diagnostic_automation"],
                },
                {
                    "name": "Groote Schuur Hospital AI Pilot",
                    "type": "hospital",
                    "focus": ["medical_imaging", "radiology_ai"],
                },
            ],
            "KEN": [
                {
                    "name": "Kenyatta National Hospital Telemedicine AI",
                    "type": "hospital",
                    "focus": ["telemedicine", "remote_diagnosis"],
                },
                {
                    "name": "Ministry of Health Digital Health Strategy",
                    "type": "government",
                    "focus": ["digital_health", "ai_strategy"],
                },
            ],
            "NGA": [
                {
                    "name": "Lagos State Health AI Initiative",
                    "type": "government",
                    "focus": ["public_health_ai", "disease_surveillance"],
                },
                {
                    "name": "Nigerian Institute of Medical Research AI Lab",
                    "type": "research_institute",
                    "focus": ["medical_research_ai", "drug_discovery"],
                },
            ],
            "GHA": [
                {
                    "name": "Ghana Health Service Digital Health Program",
                    "type": "government",
                    "focus": ["digital_health", "health_records"],
                },
                {
                    "name": "Korle-Bu Teaching Hospital AI Pilot",
                    "type": "hospital",
                    "focus": ["clinical_ai", "decision_support"],
                },
            ],
            "EGY": [
                {
                    "name": "Cairo University Hospitals AI Initiative",
                    "type": "hospital",
                    "focus": ["medical_imaging", "ai_diagnostics"],
                },
                {
                    "name": "Ministry of Health and Population Digital Transformation",
                    "type": "government",
                    "focus": ["health_digitization", "ai_integration"],
                },
            ],
        }
    ...
    def calculate_ecosystem_maturity(
        self, organizations: List[HealthAIOrganization], country_code: str
    ) -> EcosystemMetrics:
        """
        ...
        academic_activity_score = min(
            100, (universities_with_programs * 20) + (research_institutes * 15)
        )
        ...
        clinical_deployment_score = min(
            100, (hospital_ai_programs * 25) + (government_initiatives * 20)
        )
        ...
        overall_ecosystem_score = min(
            100, total_organizations * 8
        )  # Each org contributes 8 points
    ...
    def map_country_ecosystem(
        self, country_code: str
    ) -> Tuple[List[HealthAIOrganization], EcosystemMetrics]:
        """
        ...
        ecosystem_metrics = self.calculate_ecosystem_maturity(
            all_organizations, country_code
        )
        ...
        logger.info(
            f"  Ecosystem maturity score: {ecosystem_metrics.estimated_ecosystem_maturity:.1f}"
        )
        ...
        with sqlite3.connect(self.cache_db_path) as conn:
            ...
            """,
                (
                    ...
                    metrics.universities_with_programs,
                    metrics.active_startups,
                    metrics.research_institutes,
                    metrics.hospital_ai_programs,
                    metrics.government_initiatives,
                    metrics.estimated_ecosystem_maturity,
                    metrics.funding_activity_score,
                    metrics.academic_activity_score,
                    metrics.clinical_deployment_score,
    ...
    def map_all_countries(self) -> Tuple[pd.DataFrame, pd.DataFrame]:
        ...
        org_output_path = (
            self.ecosystem_cache_dir / f"health_ai_organizations_{timestamp}.csv"
        )
        org_df.to_csv(org_output_path, index=False)

        metrics_output_path = (
            self.ecosystem_cache_dir / f"ecosystem_metrics_{timestamp}.csv"
        )
    ...
    def generate_ecosystem_report(
        self, org_df: pd.DataFrame, metrics_df: pd.DataFrame
    ) -> str:
        """
        ...
        report = {
            ...
            "summary_statistics": {
                "organizations_by_country": org_df["country_name"]
                .value_counts()
                .to_dict(),
                "organizations_by_type": org_df["organization_type"]
                .value_counts()
                .to_dict(),
                "average_ecosystem_maturity": metrics_df[
                    "estimated_ecosystem_maturity"
                ].mean(),
                "top_performing_country": metrics_df.loc[
                    metrics_df["overall_ecosystem_score"].idxmax(), "country_name"
                ],
            },
        ...
        # Save report
        report_path = (
            self.ecosystem_cache_dir
            / f"ecosystem_mapping_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
...
def main():
    ...
    for _, row in metrics_df.iterrows():
        print(
            f"{row['country_name']}: {row['total_organizations']} orgs, "
